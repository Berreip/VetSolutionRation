...
internal sealed class RecipeConfigurationCalculatorTests
{
    ...
    {
        //Arrange
        var f = UtilsUnitTests.CreateFeed("feed1");
        var f2 = UtilsUnitTests.CreateFeed("feed2");
        var f3 = UtilsUnitTests.CreateFeed("feed3");
    ...
    {
        //Arrange
        var f = UtilsUnitTests.CreateIngredientFeed("feed1");
        var f2 = UtilsUnitTests.CreateIngredientFeed("feed2");
        var f3 = UtilsUnitTests.CreateIngredientFeed("feed3");
    ...
    {
        //Arrange
        var feed1 = UtilsUnitTests.CreateFeed("feed1");
    ...
    public void GetAllIndividualFeeds_filter_duplicates_if_other_not_duplicated()
    {
        //Arrange
        var feed1 = UtilsUnitTests.CreateFeed("feed1");
        var feed2 = UtilsUnitTests.CreateFeed("feed1");
